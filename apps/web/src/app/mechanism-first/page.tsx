...
export default function MechanismFirstPage() {
  return (
    <main className="page approach-page approach-page-visual">
      <p className="eyebrow">
        <Link href="/">Home</Link> · Mechanism first
      </p>

      <header className="science-hero approach-hero">
        <div className="approach-hero-copy">
          <h1>Mechanism first</h1>
          <p className="science-thesis">
            Map how disease proteins fail and which shared routes matter before designing molecules.
          </p>
          <p className="lede">
