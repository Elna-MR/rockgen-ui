...
/** Mechanism-first explainer for the multi-disease RockGen workspace. */
    ...
    <main className="page approach-page approach-page-visual">
      ...
      <header className="science-hero approach-hero">
        <div className="approach-hero-copy">
          ...
          <p className="science-thesis">
            Map how disease proteins fail — and which shared routes matter — before designing
            molecules.
          </p>
          <p className="lede">
            An educational and research workspace for neurodegeneration: ALS, Parkinson’s,
      ...
      <section className="science-section">
        ...
        <p className="article-body">
          ...
          jobs fail, researchers ask which failure is primary and which is secondary — across
          diseases, not only one program.
        </p>
      </section>
